...
- IoT, MQTT, Node-RED Dashboard
- Google Cloud Platform (GCP)
- C, C++, Python
- PHP, MySQL, SCSS, Django, Flask
- Git, R Programming
...
**AirPocket - Portable Air Quality Monitoring**  
...
**Smartwatch with Linebot Integration**  
